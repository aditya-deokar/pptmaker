...
const TOOL_SECURITY_POLICIES: Record<string, ToolSecurityPolicy> = {
  ...
  [TOOL_NAMES.PRESENTATION_RENDER_DECK]: {
    ...
    createsPublicUrl: false,
    outputMayContainUserContent: true,
    requiredScopes: getRequiredScopesForTool(TOOL_NAMES.PRESENTATION_RENDER_DECK),
  },
  [TOOL_NAMES.PRESENTATION_RENDER_THEME_STUDIO]: {
    ...
    createsPublicUrl: false,
    outputMayContainUserContent: true,
    requiredScopes: getRequiredScopesForTool(TOOL_NAMES.PRESENTATION_RENDER_THEME_STUDIO),
  },
